...
## Deploy eigenlayer contracts and save state
deploy-eigenlayer-contracts-to-anvil-and-save-state: 
	./utils/anvil/deploy-eigenlayer-save-anvil-state.sh

## Deploy AVS contracts and save state
deploy-hello-world-contracts-to-anvil-and-save-state: 
...
## deploy eigenlayer, shared avs contracts
deploy-contracts-to-anvil-and-save-state: deploy-eigenlayer-contracts-to-anvil-and-save-state deploy-hello-world-contracts-to-anvil-and-save-state 
